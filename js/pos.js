...
const POS = {
    ...
    updateDiscountUI: function() {
        ...
        suffixSpan.textContent = discountTypeValue === 'percent' ? '%' : 'ريال';
    ...
    processCashSale: function(sale) {
        ...
        sales.push(sale);
        this.safeDBSet(CONSTANTS.STORAGE_KEYS.SALES, sales);
    ...
    processCreditSale: function(sale) {
        ...
        const creditSales = this.safeDBGet(CONSTANTS.STORAGE_KEYS.CREDIT_SALES);
        creditSales.push(creditSale);
        this.safeDBSet(CONSTANTS.STORAGE_KEYS.CREDIT_SALES, creditSales);
